...
function SearchJobContent() {
    return (
        <div>
            <div>
                <section>
                    <h1><b>10127 tin tuyển dụng, tìm việc làm nhanh 24h mới nhất trên toàn quốc</b></h1>
                    <p>Tiếp cận 10,000+ doanh nghiệp tuyển dụng uy tín. Việc làm mới mỗi ngày với mức lương cao, hấp dẫn, chế độ đãi ngộ cực tốt</p>
                </section>
                <div class="bg-[url('./assets/feature-company-background.png')] bg-right bg-no-repeat pb-20 bg-sky-50 bg-contain">
                    <div>
                        <div>
                            <h2 className='font-semibold text-[22px] text-black mb-[20px] mt-[20px]'>Các Công Ty Hàng Đầu</h2>
                        </div>
                        <div class="flex flex-row justify-center max-w-[1200px] ">
                            ...
                            <div class="basis-1/6 p-[16px] m-[6px] bg-silver rounded-[6px] text-center border-solid border-1 ">
                        ...
                        <div className='border-solid rounded-[6px] h-[auto] border-2 border-sky-200'>
                            <div className='flex flex-col justify-center w-full'>
                                <div className=' bg-[url(https://staging.vietnamworks.com/assets-page-container/images/featured-jobs-background.png)] bg-no-repeat rounded-t-5px flex items-center justify-between bg-blue-100 p-[10px]'>
                                    <div className='text-[24px] font-mono font-bold'>Tuyển dụng Gấp</div>
                ...
                <section className='pt-[30px]'>
                    <div className='max-w-[1200px] px-[16px] mx-[auto] '>
                        <div className='border-solid rounded-[6px] h-[auto] border-2 border-sky-200'>
                            <div className='flex flex-col justify-center w-full'>
                                <div className=' bg-[url(https://staging.vietnamworks.com/assets-page-container/images/featured-jobs-background.png)] bg-no-repeat rounded-t-5px flex items-center justify-between bg-blue-100 p-[10px]'>
                                    <div className='text-[24px] font-mono font-bold'>Việc làm đang Hot</div>
                                    {/* <a href='/' className=' text-blue-600 font-mono'>Xem Tất Cả</a> */}
                                </div>
                                <div className='p-[24px] w-full'>
                                    <div className='flex flex-col'>
                ...
                <section className='pt-[30px]'>
                    <div className='max-w-[1200px] px-[16px] mx-[auto] '>
                        <div className='border-solid rounded-[6px] h-[auto] border-2 border-sky-200'>
                            <div className='flex flex-col justify-center w-full'>
                                <div className=' bg-[url(https://staging.vietnamworks.com/assets-page-container/images/featured-jobs-background.png)] bg-no-repeat rounded-t-5px flex items-center justify-between bg-blue-100 p-[10px]'>
                                    <div className='text-[24px] font-mono font-bold'>Việc làm bán thời gian</div>
                                    {/* <a href='/' className=' text-blue-600 font-mono'>Xem Tất Cả</a> */}
                                </div>
                                <div className='p-[24px] w-full'>
                                    <div className='flex flex-col'>
                ...
                <section className='pt-[30px]'>
                    <div className='max-w-[1200px] px-[16px] mx-[auto] '>
                        <div className='border-solid rounded-[6px] h-[auto] border-2 border-sky-200'>
                            <div className='flex flex-col justify-center w-full'>
                                <div className=' bg-[url(https://staging.vietnamworks.com/assets-page-container/images/featured-jobs-background.png)] bg-no-repeat rounded-t-5px flex items-center justify-between bg-blue-100 p-[10px]'>
                                    <div className='text-[24px] font-mono font-bold'>Việc làm lương cao</div>
                                    {/* <a href='/' className=' text-blue-600 font-mono'>Xem Tất Cả</a> */}
                                </div>
                                <div className='p-[24px] w-full'>
                                    <div className='flex flex-col'>
