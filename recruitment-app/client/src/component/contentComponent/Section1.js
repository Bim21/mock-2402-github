                    ...
                    <div className='flex max-w-full flex-col mx-auto'>
                        ...
                        <div className='rounded-[12px] shadow-slate-300 flex justify-center'>
                            <div className='max-w-[1200px] px-[16px] mx-[auto]'>
                                <a href='/' className=''>
                                    <img src='https://www.vietnamworks.com/_next/image?url=https%3A%2F%2Fimages.vietnamworks.com%2Flogo%2Fvinhome_hrbn24_125417.jpg&w=1920&q=75' alt=''
                        ...
                        <div class="flex flex-row justify-center max-w-[1200px] ">
                            <div class="basis-1/6 p-[16px] m-[6px] bg-white rounded-[6px] text-center border-solid border-1 ">
                                ...
                                className='flex flex-col justify-center items-center'>
                                    <img src='https://images.vietnamworks.com/logo/Techcom_vip_125303.jpg' alt='' className='w-[128px] h-[128px] mb-[30px]'/>
                            ...
                            <div class="basis-1/6 p-[16px] m-[6px] bg-white rounded-[6px] text-center border-solid border-1 ">
                                ...
                                className='flex flex-col justify-center items-center'>
                                    <img src='https://images.vietnamworks.com/logo/crystal_vip24_100524.jpg' alt='' className='w-[128px] h-[128px] mb-[30px]'/>
                            ...
                            <div class="basis-1/6 p-[16px] m-[6px] bg-white rounded-[6px] text-center border-solid border-1 ">
                                ...
                                className='flex flex-col justify-center items-center'>
                                    <img src='https://images.vietnamworks.com/logo/chaileaseN_vip1_125914.png' alt='' className='w-[128px] h-[128px] mb-[30px]'/>
                            ...
                            <div class="basis-1/6 p-[16px] m-[6px] bg-white rounded-[6px] text-center border-solid border-1 ">
                                ...
                                className='flex flex-col justify-center items-center'>
                                    <img src='	https://images.vietnamworks.com/logo/Lg_vip_125989.png' alt='' className='w-[128px] h-[128px] mb-[30px]'/>
                            ...
                            <div class="basis-1/6 p-[16px] m-[6px] bg-white rounded-[6px] text-center border-solid border-1 ">
                                ...
                                className='flex flex-col justify-center items-center'>
                                    <img src='https://images.vietnamworks.com/logo/asahi_vip_126052.jpg' alt='' className='w-[128px] h-[128px] mb-[30px]'/>
                            ...
                            <div class="basis-1/6 p-[16px] m-[6px] bg-white rounded-[6px] text-center border-solid border-1 ">
                                ...
                                className='flex flex-col justify-center items-center'>
                                    <img src='https://images.vietnamworks.com/logo/jotun_vip_125681.jpg' alt='' className='w-[128px] h-[128px] mb-[30px]'/>
