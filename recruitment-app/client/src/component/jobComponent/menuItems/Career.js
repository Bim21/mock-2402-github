                ...
                <div className="absolute z-10 mt-1 w-[300px] bg-white shadow-lg rounded-md " >
                    <div className="p-[8px] flex flex-col ">
                        <div className="flex flex-col">
                            <label className="flex font-bold text-[16px] leading-[19px] h-[40px] items-center mb-0 "><span>Ngành Nghề</span></label>
                        ...
                        <div className="relative min-h-[240px] mb-[8px] mt-[4px]" style={{ maxHeight: '270px', overflowY: 'auto' }}>
                            <div className="absolute w-full">
                                <div className="flex flex-col gap-1 h-[40px] pr-[4px] " >
                                    ...
                                    <div className="py-[10px] px-[8px] inline-flex items-center rounded-md hover:bg-blue-50">
                                        <input type="checkbox" id="option3" name="option3" value="hochiminh" />
                                        <label className="ml-[10px]">CEO & General Management</label>
                                    </div>
                                    <div className="py-[10px] px-[8px] inline-flex items-center rounded-md hover:bg-blue-50">
                                        <input type="checkbox" id="option3" name="option3" value="hochiminh" />
                                        <label className="ml-[10px]">Chính Phủ/ Phi lợi nhuận</label>
                                    </div>
                                    <div className="py-[10px] px-[8px] inline-flex items-center rounded-md hover:bg-blue-50">
                                        <input type="checkbox" id="option3" name="option3" value="hochiminh" />
                                        <label className="ml-[10px]">Công nghệ thông tin/ Viễn thông</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="border-t-[1px] border-gray-100 pt-[16px] px-[16px]">
                            <div className="flex justify-end">
                                ...
                                <button className="ml-[10px] h-[40px] px-[16px] rounded-md bg-orange-400 mr-[-16px] text-[14px] font-medium text-white hover:bg-orange-300">Tìm Kiếm</button>
                            </div>
                        </div>
                    </div>
                </div>
