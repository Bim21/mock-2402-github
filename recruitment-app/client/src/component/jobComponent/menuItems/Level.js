                        ...
                        <div className="relative min-h-[240px] mb-[8px] mt-[4px]" style={{ maxHeight: '270px', overflowY: 'auto' }}>
                            <div className="absolute w-full">
                                <div className="flex flex-col gap-1 h-[40px] pr-[4px] " >
                                    ...
                                    <label for="all" className="ml-[10px]">Tất cả cấp bậc</label>
                                    </div>
                                </div>
                                <div className="flex flex-col gap-1 h-[40px] pr-[4px] " >
                                    <div className="flex">
                                    <input type="radio" id="1" name="company" value="all" />
                                    <label for="all" className="ml-[10px]">Thực tập sinh/ Sinh viên</label>
                                    </div>
                                </div>
                                <div className="flex flex-col gap-1 h-[40px] pr-[4px] " >
                                    <div className="flex">
                                    <input type="radio" id="2" name="company" value="2" />
                                    <label for="all" className="ml-[10px]">Mới tốt nghiệp</label>
                                    </div>
                                </div>
                                <div className="flex flex-col gap-1 h-[40px] pr-[4px] " >
                                    <div className="flex">
                                    <input type="radio" id="3" name="company" value="3" />
                                    <label for="all" className="ml-[10px]">Nhân viên</label>
                                    </div>
                                </div>
                                <div className="flex flex-col gap-1 h-[40px] pr-[4px] " >
                                    <div className="flex">
                                    <input type="radio" id="4" name="company" value="4" />
                                    <label for="all" className="ml-[10px]">Trưởng phòng</label>
                                    </div>
                                </div>
                                <div className="flex flex-col gap-1 h-[40px] pr-[4px] " >
                                    <div className="flex">
                                    <input type="radio" id="4" name="company" value="4" />
                                    <label for="all" className="ml-[10px]">Giám đốc và cấp cao hơn</label>
                                    </div>
                                </div>
                            </div>
                        </div>
