    ...
    return (
        <div className='w-[full] h-56 bg-white rounded-[9px]  flex flex-col text-2xl'>
            <div className='m-5 ml-10 flex flex-col gap-3'>
                ...
                <div onClick={goToJobApplied} className='flex flex-row items-center gap-8 hover:border-red-500'>
                    <div className='text-green-500 font-bold'>0 </div>
                    <div className='text-blue-500'>|</div>
                    <div className='font-semibold flex flex-row justify-evenly items-center gap-56'>Việc đã ứng tuyển
                    <GrNext/>
                ...
                <div onClick={goToJobViewed} className='flex flex-row items-center gap-8'>
                    <div className='text-black font-bold'>0 </div>
                    <div className='text-blue-500'>|</div>
                    <div className='font-semibold flex flex-row justify-evenly items-center gap-56'>Lượt xem việc làm
                    <GrNext/>
                ...
                <div onClick={goToSaved} className='flex flex-row items-center gap-8'>
                    ...
                    <div className='text-blue-500'>|</div>
                    <div className='font-semibold flex flex-row justify-evenly items-center gap-60'>Lượt tìm việc làm
