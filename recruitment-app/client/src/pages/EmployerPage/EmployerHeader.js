...
const EmployerHeader = () => {
  ...
  const [isOpenMenuEmployer, setIsOpenMenuEmployer] = useState(false);
  ...
  const toggleMenu2 = () => {
    setIsOpenMenuEmployer(!isOpenMenuEmployer);
  };
    ...
    <div className="flex p-[20px] h-[56px] bg-gradient-to-r from-sky-950 via-blue-950 to-blue-600 w-full items-center">
      ...
      <div className="flex items-center w-full">
        <ul className="flex text-white gap-x-4 ml-2 text-[14px] font-normal">
          ...
          <div className="flex hover:cursor-pointer hover:text-orange-600">
            Ứng Viên
        ...
        <div className="ml-2">
          <ul className="flex gap-x-2 text-white">
            ...
            <button className="bg-orange-400 hover:bg-orange-600 rounded-lg p-2">
              Tìm ứng viên
            </button>
            <button className="bg-orange-400 hover:bg-orange-600 rounded-lg p-2 px-8">
              Mua
            </button>
          </ul>
        </div>
      ...
      <div className="flex justify-end items-center gap-x-4">
        <div className="flex items-center relative group" ref={dropdownRef}>
          <button onClick={toggleMenu} className=" focus:outline-none">
            <LiaLanguageSolid className=" text-white hover:cursor-pointer hover:text-white rounded-[95px] w-[24px] h-full" />
          </button>
          {isOpen && (
            <div className="absolute top-6 right-0 mt-2 w-40 bg-white border border-gray-200 rounded shadow-md z-10 ">
              <ul>
        ...
        <div>
          <MdLocalGroceryStore className=" text-white hover:cursor-pointer hover:text-white rounded-[95px] w-[24px] h-full" />
        </div>
        <div>
          <IoIosNotifications className=" text-white hover:cursor-pointer hover:text-white rounded-[95px] w-[24px] h-full" />
        </div>
        <div className="flex items-center relative group" ref={dropdownRef}>
          <button onClick={toggleMenu2} className=" focus:outline-none">
            <MdAccountCircle className=" text-white hover:cursor-pointer hover:text-white rounded-[95px] w-[24px] h-full" />
          </button>
          {isOpenMenuEmployer && (
            <div className="absolute top-6 right-0 mt-2 w-40 bg-white border border-gray-200 rounded shadow-md z-10 ">
              <ul>
                <li className="py-2 px-4 text-[14px] text-blue-600 hover:bg-gray-100 cursor-pointer">
                  <span className="font-bold">
                    Xin Chào, {employerInfo?.firstName}
                  </span>
                </li>
                <li className="py-2 px-4 text-[14px] text-blue-600 hover:bg-gray-100 cursor-pointer">
