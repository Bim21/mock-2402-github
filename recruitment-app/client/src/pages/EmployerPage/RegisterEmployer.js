    ...
    return (
        <div className='h-screen flex justify-center items-center'>
            ...
            <form onSubmit={handleSubmit} className="p-4 max-w-md mx-auto bg-slate-50 rounded-lg">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700">Ngành nghề<span className='text-red-500'>*</span></label>
                    <select name="career" value={formData.career} onChange={handleChange} className="w-full p-2 border rounded mb-4">
