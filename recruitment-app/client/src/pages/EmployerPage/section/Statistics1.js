    ...
    <div className="mb-[10px] flex flex-row w-full ">
        ...
        <div className="bg-sky-100 flex justify-between rounded-lg shadow-md w-full">
          <div className="p-4">
            ...
            <div className="flex mt-[10px] text-[14px]">
              ...
              />
              <a
                href="https://faq.vietnamworks.com/employers-vi/"
                className="text-blue-400 hover:text-slate-900"
              >
            ...
            <div className="flex mt-[10px] text-[14px]">
              ...
              />
              <a
                href="https://employer.vietnamworks.com/choose-services"
                className="text-blue-400 hover:text-slate-900"
              >
                Khám phá sản phẩm
              </a>
          ...
          <div className="flex flex-col items-end justify-end pr-4 pb-0">
            <img
              src="https://employer.vietnamworks.com/v2/dashboard/static/media/img-section-welcome.44cf26351d8ef0e81c024194906421ae.svg"
              alt=""
        ...
        <div className=" w-full rounded-lg mt-4 py-4 px-2 shadow-[0_0_6px_-3px_rgba(0,0,0,0.3)] bg-white">
          ...
          <div className="flex w-full mt-4 min-h-[170px]">
            <div className="w-[50%] bg-gray-100 px-[4px] mr-2 flex items-center rounded-lg">
              <div className="ml-2">
                <div className="text-[24px] font-semibold text-orange-400">
                  0
                </div>
      ...
      <div className="w-[75%] ml-2 bg-white rounded-lg flex-col justify-center items-end shadow-[0_0_6px_-3px_rgba(0,0,0,0.3)]">
        ...
        <div className="h-[10%] bg-sky-100 text-center py-[10px] rounded-b-lg border-t-[1px]">
          <div className="text-[14px] text-blue-400 hover:cursor-pointer hover:text-slate-800">
            Xem tất cả báo cáo {">"}{" "}
          </div>
        </div>
      </div>
